...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='bitcoinflash.conf'
CONFIGFOLDER='/root/.bitcoinflash'
COIN_DAEMON='bitcoinflashd'
COIN_CLI='bitcoinflash-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/BitcoinFlashDEV/BitcoinFlash/releases/download/v1.0.0.1/bitcoinflash-1.0.0-x86_64-linux-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='Bitcoinflash'
COIN_PORT=23500
RPC_PORT=23502
